...
public class PunchController {
    ...
    public ResponseEntity<TimeCalculationResponse> calculateTime(@PathVariable Integer employeeId) {
        logger.info("Time calculation for web punch data started.");
        TimeCalculationResponse timeResponse = punchService.calculateTime(employeeId);
